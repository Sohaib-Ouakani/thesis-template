...
Il lavoro dimostra la fattibilità di un approccio monolinguaggio per applicativi che interagiscono con librerie native, evidenziando anche i limiti attuali dell'eco\-sistema Kotlin/Native che ne condizionano la maturità per un'adozione industriale più ampia.
\end{abstract}

\begin{dedication}
Alla mia Peugeot 206 verde, che barcolla ma non molla.
\end{dedication}
